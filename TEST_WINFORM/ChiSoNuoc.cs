...
namespace TEST_WINFORM
{
    public partial class ChiSoNuoc : Form
    {
        ...
        {
            string query = "select DiChia as N'Nhà' , MaPhongTro as N'Phòng' , TienNuoc as N'Tiền nước' " +
        ...
        private void ChiSoNuoc_Shown(object sender, EventArgs e)
        {
            LayNha();
            LayTrangThai();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "select nt.DiChia as N'Nhà trọ', pt.MaPhongTro as N'Số phòng', pt.TienNuoc as N'Tiền nước' " +
        ...
        private void dgvPhong_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                txtNC.Text = dongchon.Cells[2].Value.ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int tienNuoc = int.Parse(txtNM.Text);
            QUERY_DB_QLNT.CapNhatGiaNuoc(tienNuoc, id);
            LayThongTinPhong();
            txtNM.Text = "";
        }
    }
